	...
	<div id="full">
				...
				<td>
                    ...
                    else
                    {
                    	?>
                           <tr>
					<td>Status</td>
					<td><input type="text" name="Status" value="Not- Availebal" disabled="disabled" title="Status"></td>
				</tr>          
                    	<?php
                    }
        ...
        if(isset($_POST['submit']))
        {
        	...
        	$member=$_POST['members'];
        		...
        		if(mysqli_query($a,"insert into f1(name,city,dis,email,state,cidate,codate,member,id,rono) value('$name','$city','$dis','$email','$state','$coin','$coout','$m','$idno','$rno')"))
        		{

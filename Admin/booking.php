...
<body>
	<div id="full">
		...
		<div id="header">
			...
			<div id="nav">
				<ul id="a1">
					<li><a href="ahome.php" style="color: black;">Home</a></li>
					<li><a href="room.php" style="color: black;">Room Update</a></li>
					<li><a href="booking.php" style="color: black;">Booking</a></li>
					<li><a href="rd.php" style="color: black;">Room Dateils</a></li>
			...
			<table>
				<tr>
					<th width="10%" height="50px">Name</th>
                     ...
                     <th width="10%" height="50px">Remove</th>
				...
				<tr>
					...
					<td width="10%" height="50px"><center><a style="color: blue" href="ak.php? idno=<?php echo $idno; ?>" >Remove</a></center></td>
				</tr>
				<?php
				  }
				?>
